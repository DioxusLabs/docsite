...
```rust, no_run
{{#include ../docs-examples/src/untested_06/component_lifecycle.rs:use_hook}}
```
```inject-dioxus
DemoFrame {
...
```rust, no_run
{{#include ../docs-examples/src/untested_06/component_lifecycle.rs:rerenders}}
```
```inject-dioxus
DemoFrame {
...
```rust, no_run
{{#include ../docs-examples/src/untested_06/component_lifecycle.rs:dont_mutate}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_06/component_lifecycle.rs:effect}}
```
```inject-dioxus
DemoFrame {
...
```rust, no_run
{{#include ../docs-examples/src/untested_06/component_lifecycle.rs:drop}}
```
```inject-dioxus
DemoFrame {
