...
```rust
{{#include src/doc_examples/untested_06/migration.rs:element_fixed}}
```
...
```rust
{{#include src/doc_examples/untested_06/migration.rs:prevent_default_old}}
```

Dioxus 0.6:

```rust
{{#include src/doc_examples/untested_06/migration.rs:prevent_default_new}}
```
...
>
> ```rust
> {{#include src/doc_examples/untested_06/migration.rs:prevent_default_new_liveview}}
> ```
...
```rust
{{#include src/doc_examples/untested_06/migration.rs:assets_new}}
```
