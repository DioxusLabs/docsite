...
```rust
{{#include src/doc_examples/untested_04/server_function.rs}}
```
...
```rust
{{#include src/doc_examples/untested_04/server_data_fetch.rs}}
```
...
```rust
{{#include src/doc_examples/untested_04/server_data_prefetch.rs}}
```
...
```rust
{{#include src/doc_examples/untested_04/server_function_desktop_client.rs:server_url}}
```
...
```rust
{{#include src/doc_examples/untested_04/server_function_desktop_client.rs:server_function}}
```

The `GetServerData` type has to be registered in the axum server, which will add the corresponding route to the server.
```rust
{{#include src/doc_examples/untested_04/server_function_desktop_client.rs:function_registration}}
```
