...
- [Recipies](reference/index.md)
  - [Platforms](reference/platforms/index.md)
	- [Desktop](reference/platforms/desktop/index.md)
		- [Publishing](reference/platforms/desktop/publishing.md)
	- [TUI](reference/platforms/tui.md)
	- [Web](reference/platforms/web/index.md)
		- [Publishing](reference/platforms/web/publishing.md)
  ...
  - [State Managment](reference/state/index.md)
	...
	- [External State](reference/state/external/index.md)
		- [Use Coroutine](reference/state/external/use_coroutine.md)
	- [Custom Hooks](reference/state/custom_hooks/index.md)
		- [Spawn](reference/state/custom_hooks/spawn.md)
  - [Antipatterns](reference/antipatterns.md)
