...
```rust
{{#include ../docs-examples/src/migration.rs:element_fixed}}
```
...
```rust
{{#include ../docs-examples/src/migration.rs:prevent_default_old}}
```

Dioxus 0.6:

```rust
{{#include ../docs-examples/src/migration.rs:prevent_default_new}}
```
...
>
> ```rust
> {{#include ../docs-examples/src/migration.rs:prevent_default_new_liveview}}
> ```
...
```rust
{{#include ../docs-examples/src/migration.rs:assets_new}}
```
