...
\```rust, ignore
{{#include ../docs-examples/src/custom_renderer.rs:derive_state}}
\```

Lets take a look at how to implement the State trait for a simple renderer.

\```rust
{{#include ../docs-examples/src/custom_renderer.rs:state_impl}}
\```
...
\```rust
{{#include ../docs-examples/src/custom_renderer.rs:rendering}}
\```
...
\```rust
{{#include ../docs-examples/src/custom_renderer.rs:cursor}}
\```
