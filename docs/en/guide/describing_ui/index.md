...
```rust
{{#include docs/examples/hello_world_desktop.rs:component}}
```
...
```rust
{{#include docs/examples/rsx_overview.rs:empty}}
```
```html
<div></div>
```
...
```rust
{{#include docs/examples/rsx_overview.rs:attributes}}
```
```html
...
```rust
{{#include docs/examples/rsx_overview.rs:custom_attributes}}
```
```html
...
```rust
{{#include docs/examples/rsx_overview.rs:formatting}}
```
```html
...
```rust
{{#include docs/examples/rsx_overview.rs:children}}
```
```html
<ol>
    <li>First Item</li>
...
```rust
{{#include docs/examples/rsx_overview.rs:manyroots}}
```
...
```rust
{{#include docs/examples/rsx_overview.rs:expression}}
```
```html
...
```rust
{{#include docs/examples/rsx_overview.rs:loops}}
```
```html
<div>0</div>
<div>1</div>
...
```rust
{{#include docs/examples/rsx_overview.rs:ifstatements}}
```
```html
<div>true</div>
```