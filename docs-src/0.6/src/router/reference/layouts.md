...
```rust
{{#include ../docs-examples/src/untested_06/outlet.rs:outlet}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/outlet.rs:outlet_with_params}}
```

Or to get the full route, you can use the `use_route` hook.

```rust
{{#include ../docs-examples/src/untested_06/outlet.rs:outlet_route}}
```
