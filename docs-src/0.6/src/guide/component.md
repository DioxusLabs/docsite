...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/guide_component.rs:dog_app_component_props_fn}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/guide_component.rs:dog_app_component_props}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/guide_component.rs:dog_app_component_macro}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/guide_component.rs:dog_app_component_props_clone}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/guide_component.rs:dog_app_component_run}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/guide_component.rs:dog_app_component_compose}}
```
