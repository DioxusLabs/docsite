...
```rust
{{#include docs/examples/hooks_counter.rs:component}}
```
...
```rust
{{#include docs/examples/hooks_counter_two_state.rs:component}}
```
...
```rust
{{#include docs/examples/hooks_counter_two_state.rs:use_state_calls}}
```
...
```rust
{{#include docs/examples/hooks_bad.rs:conditional}}
```

### No Hooks in Closures
```rust
{{#include docs/examples/hooks_bad.rs:closure}}
```

### No Hooks in Loops
```rust
{{#include docs/examples/hooks_bad.rs:loop}}
```
...
```rust
{{#include docs/examples/hooks_use_ref.rs:component}}
```
