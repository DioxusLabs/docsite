...
```rust
{{#include src/doc_examples/untested_06/reactivity.rs:signal}}
```
...
```rust
{{#include src/doc_examples/untested_06/reactivity.rs:signal_read}}
```
...
```rust
{{#include src/doc_examples/untested_06/reactivity.rs:signal_write}}
```
...
```rust
{{#include src/doc_examples/untested_06/reactivity.rs:effect}}
```
...
```rust
{{#include src/doc_examples/untested_06/reactivity.rs:memo}}
```
...
```rust
{{#include src/doc_examples/untested_06/reactivity.rs:resource}}
```
...
```rust
{{#include src/doc_examples/untested_06/reactivity.rs:component}}
```
...
```rust
{{#include src/doc_examples/untested_06/reactivity.rs:non_reactive}}
```
...
```rust
{{#include src/doc_examples/untested_06/reactivity.rs:use_reactive}}
```
...
```rust
{{#include src/doc_examples/untested_06/reactivity.rs:peek}}
```
...
```rust
{{#include src/doc_examples/untested_06/reactivity.rs:making_props_reactive}}
```
...
```rust
{{#include src/doc_examples/untested_06/moving_state_around.rs:PassingProps}}
```
...
```rust
{{#include src/doc_examples/untested_06/moving_state_around.rs:PassingContext}}
```
...
```rust
{{#include src/doc_examples/untested_06/moving_state_around.rs:UsingGlobals}}
```
