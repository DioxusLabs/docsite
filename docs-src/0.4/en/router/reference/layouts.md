...
```rust
{{#include src/doc_examples/untested_04/outlet.rs:outlet}}
```
...
```rust
{{#include src/doc_examples/untested_04/outlet.rs:outlet_with_params}}
```
...
```rust
{{#include src/doc_examples/untested_04/outlet.rs:outlet_route}}
```
