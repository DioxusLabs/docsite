...
```rust
{{#include src/doc_examples/untested_04/nested_routes.rs:nav}}
```

Next, let's add our `NavBar` component as a layout to our Route enum:

```rust
{{#include src/doc_examples/untested_04/nested_routes.rs:router}}
```
...
```rust
{{#include src/doc_examples/untested_04/links.rs:nav}}
```
...
```rust
{{#include src/doc_examples/untested_04/dynamic_route.rs:blog}}
```
...
```rust
{{#include src/doc_examples/untested_04/dynamic_route.rs:blog_list}}
```
...
```rust
{{#include src/doc_examples/untested_04/dynamic_route.rs:blog_post}}
```

Finally, let's tell our router about those components:

```rust
{{#include src/doc_examples/untested_04/dynamic_route.rs:router}}
```
