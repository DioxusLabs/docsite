...
```rust
{{#include ../docs-examples/src/untested_04/outlet.rs:outlet}}
```
...
```rust
{{#include ../docs-examples/src/untested_04/outlet.rs:outlet_with_params}}
```
...
```rust
{{#include ../docs-examples/src/untested_04/outlet.rs:outlet_route}}
```
