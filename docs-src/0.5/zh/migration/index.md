...
Dioxus 0.5:
\```rust
{{#include ../docs-examples/src/migration.rs:scope}}
\```
...
Dioxus 0.5:
\```rust
{{#include ../docs-examples/src/migration.rs:props}}
\```
...
Dioxus 0.5:
\```rust
{{#include ../docs-examples/src/migration.rs:futures}}
\```
...
\```rust
{{#include ../docs-examples/src/migration.rs:state}}
\```
...
Dioxus 0.5:
\```rust
{{#include ../docs-examples/src/migration.rs:fermi}}
\```
