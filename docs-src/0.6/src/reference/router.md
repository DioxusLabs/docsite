...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/router_reference.rs:router_definition}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/router_reference.rs:router_definition_404}}
```

- Redirect 404 to home

```rust
{{#include ../docs-router/src/doc_examples/untested_06/router_reference.rs:router_404_redirect}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/router_reference.rs:links}}
```
