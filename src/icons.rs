...
pub static ExternalLinkIcon: Component<()> = |cx| {
    cx.render(rsx! {
        svg { width: "15", height: "15", y: "0px", x: "0px", view_box: "0 0 100 100",
            path {
                fill: "currentColor",
...
pub static Copy: Component<()> = |cx| {
    cx.render(rsx!(
        svg { width: "24", stroke_width: "1.5", height: "24", fill: "none", stroke: "currentColor",
...
pub static GithubLogo: Component<()> = |cx| {
    cx.render(rsx!(
        svg { height: "24", width: "24", fill: "currentColor", view_box: "0 0 16 16",
            path {
                fill_rule: "evenodd",
