...
> Note: All attributes defined in [`dioxus-html`](https://docs.rs/dioxus-html/~0.5/dioxus_html/) follow the snake_case naming convention. They transform their `snake_case` names to HTML's `camelCase` attributes.
