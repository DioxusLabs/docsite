...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_06/input_controlled.rs:component}}
```
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_06/input_uncontrolled.rs:component}}
```
```inject-dioxus
DemoFrame {
