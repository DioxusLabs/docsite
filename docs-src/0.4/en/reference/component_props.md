...
```rust, no_run
{{#include ../docs-examples/src/untested_04/component_owned_props.rs:Likes}}
```

You can then pass prop values to the component the same way you would pass attributes to an element:

```rust, no_run
{{#include ../docs-examples/src/untested_04/component_owned_props.rs:App}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_04/component_borrowed_props.rs:TitleCard}}
```

We can then use the component like this:

```rust, no_run
{{#include ../docs-examples/src/untested_04/component_borrowed_props.rs:App}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_04/component_props_options.rs:OptionalProps}}
```

Then, you can choose to either provide them or not:

```rust, no_run
{{#include ../docs-examples/src/untested_04/component_props_options.rs:OptionalProps_usage}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_04/component_props_options.rs:ExplicitOption}}
```

Then, you have to explicitly pass either `Some("str")` or `None`:

```rust, no_run
{{#include ../docs-examples/src/untested_04/component_props_options.rs:ExplicitOption_usage}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_04/component_props_options.rs:DefaultComponent}}
```

Then, similarly to optional props, you don't have to provide it:

```rust, no_run
{{#include ../docs-examples/src/untested_04/component_props_options.rs:DefaultComponent_usage}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_04/component_props_options.rs:IntoComponent}}
```

Then, you can use it so:

```rust, no_run
{{#include ../docs-examples/src/untested_04/component_props_options.rs:IntoComponent_usage}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_04/component_element_props.rs:Clickable}}
```

Then, when rendering the component, you can pass in the output of `cx.render(rsx!(...))`:

```rust, no_run
{{#include ../docs-examples/src/untested_04/component_element_props.rs:Clickable_usage}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_04/component_children.rs:Clickable}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_04/component_children.rs:Clickable_usage}}
```
