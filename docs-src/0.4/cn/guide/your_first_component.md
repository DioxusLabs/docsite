...
To declare what you want your UI to look like, you will need to use the `rsx` macro. Let's modify the rsx macro in the `App` function from the [入门指南](../getting_started/index.md) to show information about our story:
