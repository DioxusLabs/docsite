...
```rust
{{#include ../docs-router/src/doc_examples/untested_05/assets.rs:images}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_05/assets.rs:optimized_images}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_05/assets.rs:arbitrary_files}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_05/assets.rs:style_sheets}}
```
...
You can read more about assets and all the options available to optimize your assets in the [manganis documentation](https://docs.rs/manganis/~0.2/manganis/).
