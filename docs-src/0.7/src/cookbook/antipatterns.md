...
```rust
{{#include ../docs-examples/src/anti_patterns.rs:nested_fragments}}
```
...
```rust
{{#include ../docs-examples/src/anti_patterns.rs:iter_keys}}
```
...
```rust
{{#include ../docs-examples/src/anti_patterns.rs:interior_mutability}}
```
...
```rust
{{#include ../docs-examples/src/anti_patterns.rs:updating_state}}
```
...
```rust
{{#include ../docs-examples/src/anti_patterns.rs:large_state}}
```
...
```rust
{{#include ../docs-examples/src/anti_patterns.rs:non_deterministic}}
```
...
```rust
{{#include ../docs-examples/src/anti_patterns.rs:permissive_partial_eq}}
```
