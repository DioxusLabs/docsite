...
```rust
{{#include ../docs-router/src/doc_examples/untested_03/dangerous_inner_html.rs:dangerous_inner_html}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_03/boolean_attribute.rs:boolean_attribute}}
```
