...
```rust
{{#include ../docs-examples/src/untested_06/hydration.rs:hydration_intro}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/hydration.rs:server_cached}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/hydration.rs:server_future}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/hydration.rs:effects}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/hydration.rs:server_hook_side_effects}}
```
