...
```rust
{{#include ../docs-router/src/doc_examples/untested_03/rsx_overview.rs:manyroots}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_03/rsx_overview.rs:loops}}
```
```html
<div>0</div>
<div>1</div>
...
```rust
{{#include ../docs-router/src/doc_examples/untested_03/rsx_overview.rs:ifstatements}}
```
```html
<div>true</div>
```
