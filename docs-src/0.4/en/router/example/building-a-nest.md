...
```rust
{{#include ../docs-examples/src/untested_04/nested_routes.rs:nav}}
```

Next, let's add our `NavBar` component as a layout to our Route enum:

```rust
{{#include ../docs-examples/src/untested_04/nested_routes.rs:router}}
```
...
```rust
{{#include ../docs-examples/src/untested_04/dynamic_route.rs:blog}}
```
...
```rust
{{#include ../docs-examples/src/untested_04/dynamic_route.rs:blog_list}}
```
...
```rust
{{#include ../docs-examples/src/untested_04/dynamic_route.rs:blog_post}}
```

Finally, let's tell our router about those components:

```rust
{{#include ../docs-examples/src/untested_04/dynamic_route.rs:router}}
```
