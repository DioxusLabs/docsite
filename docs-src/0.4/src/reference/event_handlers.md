...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_04/event_click.rs:rsx}}
```
```inject-dioxus
DemoFrame {
    event_click::App {}
...
To learn what the different event types for HTML provide, read the [events module docs](https://docs.rs/dioxus-html/~0.4/dioxus_html/events/index.html).
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_04/event_nested.rs:rsx}}
```
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_04/event_prevent_default.rs:prevent_default}}
```
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_04/event_handler_prop.rs:component_with_handler}}
```

Then, you can use it like any other handler:

```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_04/event_handler_prop.rs:usage}}
```
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_04/event_handler_prop.rs:custom_data}}
```
