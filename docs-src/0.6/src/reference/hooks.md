...
[`use_signal`](https://docs.rs/dioxus/~0.6/dioxus/prelude/fn.use_signal.html) is one of the simplest hooks.
...
> `use_signal` returns your value wrapped in a smart pointer of type [`Signal`](https://docs.rs/dioxus/~0.6/dioxus/prelude/struct.Signal.html) that is `Copy`. This is why you can both read the value and update it, even within an event handler.
...
- [dioxus_hooks API docs](https://docs.rs/dioxus-hooks/~0.6/dioxus_hooks/)
