...
```rust
{{#include ../docs-examples/src/untested_04/use_future.rs:use_future}}
```
...
```rust
{{#include ../docs-examples/src/untested_04/use_future.rs:render}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_04/use_future.rs:dependancy}}
```
