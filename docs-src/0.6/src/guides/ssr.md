...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/ssr.rs:main}}
```

And then add our endpoint. We can either render `rsx!` directly:

```rust
{{#include ../docs-router/src/doc_examples/untested_06/ssr.rs:app_endpoint}}
```

Or we can render VirtualDoms.

```rust
{{#include ../docs-router/src/doc_examples/untested_06/ssr.rs:app_endpoint_vdom}}
```
