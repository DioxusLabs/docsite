...
pub fn Index(section: IndexSection) -> dioxus::prelude::Element {
    ...
    rsx! {
        ...
        p {
            img {
                src: asset!(
                    "/assets/blog/release-03/dioxuslogo_full.png", ImageAssetOptions::new()
                    .with_webp()
                ),
                alt: "dioxuslogo",
                title: "",
...
pub fn DescribingUiComponents(section: DescribingUiComponentsSection) -> dioxus::prelude::Element {
    ...
    rsx! {
        ...
        p {
            img {
                src: asset!(
                    "/assets/blog/release-03/screenshot_about_component.png",
...
pub fn DescribingUiComponentProps(
    ...
    rsx! {
        ...
        p {
            img {
                src: asset!(
                    "/assets/blog/release-03/component_owned_props_screenshot.png",
                    ImageAssetOptions::new().with_webp()
                ),
        ...
        p {
            img {
                src: asset!(
                    "/assets/blog/release-03/component_borrowed_props_screenshot.png",
                    ImageAssetOptions::new().with_webp()
                ),
...
pub fn InteractivityHooks(section: InteractivityHooksSection) -> dioxus::prelude::Element {
    ...
    rsx! {
        ...
        p {
            img {
                src: asset!("/assets/blog/release-03/counter.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!(
                    "/assets/blog/release-03/counter_two_state.png", ImageAssetOptions::new()
                    .with_webp()
                ),
...
pub fn InteractivitySharingState(
    ...
    rsx! {
        ...
        p {
            img {
                src: asset!(
                    "/assets/blog/release-03/meme_editor_screenshot.png", ImageAssetOptions::new()
                    .with_webp()
                ),
...
pub fn PublishingDesktop(section: PublishingDesktopSection) -> dioxus::prelude::Element {
    ...
    rsx! {
        ...
        p {
            img {
                src: asset!("/assets/static/publish.png", ImageAssetOptions::new().with_webp()),
                alt: "Published App",
                title: "",
            }
        }
