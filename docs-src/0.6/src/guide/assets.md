...
```rust
{{#include src/doc_examples/untested_06/guide_assets.rs:css_asset}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_assets.rs:css_stylesheet}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_assets.rs:url_image}}
```

For static images, you can use the same `asset!()` macro that we used to include the app's CSS.

```rust
{{#include src/doc_examples/untested_06/guide_assets.rs:asset_image}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_assets.rs:asset_optimization}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_assets.rs:image_asset_expansion}}
```
