...
pub fn IntroducingDioxus(section: IntroducingDioxusSection) -> dioxus::prelude::Element {
    ...
    rsx! {
        ...
        p {
            img {
                src: asset!("/assets/static/Untitled.png", ImageAssetOptions::new().with_webp()),
                alt: "Teaser Example",
                title: "",
            }
        }
        ...
        p {
            img {
                src: asset!("/assets/static/counter.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/ide_hover.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/ide_autocomplete.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/ide_listener.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/ide_selection.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/ide_rsx.png", ImageAssetOptions::new().with_webp()),
        ...
        ul {
            ...
            li { "Support for borrowed props" }
            li { "Conditional rendering" }
            li { "CSS/Styling/Inline style support" }
            li { "Support for inline Context Providing/Consuming" }
            li { "First-class global state management" }
        }
        p {
...
pub fn TemplatesDiffing(section: TemplatesDiffingSection) -> dioxus::prelude::Element {
    ...
    rsx! {
        ...
        p {
            img {
                src: asset!(
                    "/assets/blog/diffing/jsframework-diffing.png", ImageAssetOptions::new()
                    .with_webp()
                ),
                alt: "Untitled",
                title: "",
        ...
        p {
            img {
                src: asset!("/assets/blog/diffing/bump-alloc.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/blog/diffing/elixir.jpeg", ImageAssetOptions::new().with_webp()),
...
pub fn Release040(section: Release040Section) -> dioxus::prelude::Element {
    ...
    rsx! {
        ...
        p {
            img {
                src: asset!("/assets/static/split_codegen.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/old_fetch.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/new_fetch.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/enum_router.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/landing_1.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/landing_2.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/landing_3.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/landing_4.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/landing_5.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/ios_demo.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/android_demo.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/bundle.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/dxcheck.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            img {
                src: asset!("/assets/static/extension.png", ImageAssetOptions::new().with_webp()),
...
pub fn Release060(section: Release060Section) -> dioxus::prelude::Element {
    ...
    rsx! {
        ...
        p { "Headlining the release is a complete overhaul of the Dioxus CLI:" }
        ul {
            li {
                strong {
                    Link {
        ...
        ul {
            li { "Dramatically improve the quality of hot-reloading, autocomplete, and asset bundling." }
            li { "Make the Dioxus CLI more robust and easier to use." }
        ...
        p {
            img {
                src: asset!("/assets/06assets/image1.png", ImageAssetOptions::new().with_webp()),
                alt: "new-cli.png",
                title: "",
            }
        }
        ...
        ul {
            ...
            li { "Inline support for iOS and Android emulators." }
        }
        p {
        ...
        p {
            ...
            code { "dx serve --platform ios/android" }
            " out of the box! 🎉"
        }
        p {
        ...
        p {
            img {
                src: asset!("/assets/06assets/image.png", ImageAssetOptions::new().with_webp()),
        ...
        p {
            ...
            code { "main.rs" }
            " for mobile - no other tools have supported the same  "
            code { "main.rs" }
            " for every platform until now."
        }
        p {
            "Our inline mobile support requires no extra configurations, no manual setup for Gradle, Java, Cocoapods, and no other 3rd party tooling. If you already have the Android NDK or iOS Simulator installed, you currently are less than 30 seconds away from a production-ready mobile app written entirely in Rust."
        }
        ...
        ul {
            li { "Hot-reload formatted strings" }
            li { "Hot-reload nested rsx blocks" }
            li { "Hot-reload component properties and simple Rust expressions" }
            li { "Hot-reload mobile platforms and their bundled assets" }
        }
        p {
            "The new hot-reloading engine almost feels like magic - you can quickly iterate on new designs - and even modify simple Rust code! - without waiting for full rebuilds:"
        }
        ...
        p {
            "The new engine allows you to modify formatted strings anywhere in your  "
            code { "rsx" }
            ": in text blocks, element attributes, and even on component properties."
        }
        CodeBlock {
        ...
        p {
            "The same tooling that enables component props reloading also works with "
            em { "any Rust literal!" }
        ...
        p {
            video {
                src: asset!("/assets/06assets/prop-hotreload.mp4"),
                alt: "prop-hotreload.mp4",
                title: "",
                autoplay: true,
                muted: true,
                r#loop: true,
        ...
        p {
            img {
                src: asset!(
                    "/assets/06assets/breadcrumbs_shadow.png", ImageAssetOptions::new().with_webp()
                ),
