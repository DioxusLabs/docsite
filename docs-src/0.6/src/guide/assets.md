...
```rust
{{#include ../docs-examples/src/untested_06/guide_assets.rs:css_asset}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/guide_assets.rs:css_stylesheet}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/guide_assets.rs:url_image}}
```

For static images, you can use the same `asset!()` macro that we used to include the app's CSS.

```rust
{{#include ../docs-examples/src/untested_06/guide_assets.rs:asset_image}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/guide_assets.rs:asset_optimization}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/guide_assets.rs:image_asset_expansion}}
```
