...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/server_function.rs}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/server_data_fetch.rs}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/server_data_prefetch.rs}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/server_function_desktop_client.rs:server_url}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/server_function_desktop_client.rs:server_function}}
```
