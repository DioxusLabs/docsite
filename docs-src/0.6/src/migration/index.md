...
```rust
{{#include ../docs-examples/src/untested_06/migration.rs:element_fixed}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/migration.rs:prevent_default_old}}
```

Dioxus 0.6:

```rust
{{#include ../docs-examples/src/untested_06/migration.rs:prevent_default_new}}
```
...
>
> ```rust
> {{#include ../docs-examples/src/untested_06/migration.rs:prevent_default_new_liveview}}
> ```
...
```rust
{{#include ../docs-examples/src/untested_06/migration.rs:assets_new}}
```
