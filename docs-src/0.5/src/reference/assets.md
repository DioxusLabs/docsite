...
```rust
{{#include ../docs-examples/src/untested_05/assets.rs:images}}
```
...
```rust
{{#include ../docs-examples/src/untested_05/assets.rs:optimized_images}}
```
...
```rust
{{#include ../docs-examples/src/untested_05/assets.rs:arbitrary_files}}
```
...
```rust
{{#include ../docs-examples/src/untested_05/assets.rs:style_sheets}}
```
