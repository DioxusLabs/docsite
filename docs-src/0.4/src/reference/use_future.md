...
```rust
{{#include ../docs-router/src/doc_examples/untested_04/use_future.rs:use_future}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_04/use_future.rs:render}}
```
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_04/use_future.rs:dependancy}}
```
