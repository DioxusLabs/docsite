...
```rust
{{#include src/doc_examples/untested_06/guide_router.rs:new_router}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_router.rs:new_router_with_component}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_router.rs:rendering_the_route}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_router.rs:catch_all}}
```
...
```rust
use crate::Route;
{{#include src/doc_examples/untested_06/guide_router.rs:nav_bar}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_router.rs:link}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_router.rs:nav_bar_router}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_router.rs:favorites}}
```

And then let's make sure to add a new variant in our `Route` enum:

```rust
{{#include src/doc_examples/untested_06/guide_router.rs:favorites_router}}
```
...
```rust
use crate::Route;
{{#include src/doc_examples/untested_06/guide_router.rs:nav_bar_favorites_link}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_router.rs:list_dogs}}
```
...
```rust
{{#include src/doc_examples/untested_06/guide_router.rs:favorites_list_dogs}}
```
