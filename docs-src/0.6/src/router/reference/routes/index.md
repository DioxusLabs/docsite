...
```rust
{{#include src/doc_examples/untested_06/static_segments.rs:route}}
```
...
```rust
{{#include src/doc_examples/untested_06/dynamic_segments.rs:route}}
```
...
```rust
{{#include src/doc_examples/untested_06/catch_all_segments.rs:route}}
```
...
```rust
{{#include src/doc_examples/untested_06/query_segments.rs:route}}
```
