...
```rust, no_run
{{#include src/doc_examples/untested_06/hooks_counter.rs:component}}
```
```inject-dioxus
DemoFrame {
   hooks_counter::App {}
...
```rust, no_run
{{#include src/doc_examples/untested_06/hooks_counter_two_state.rs:component}}
```
...
```rust, no_run
{{#include src/doc_examples/untested_06/hooks_use_signal.rs:component}}
```
...
```rust, no_run
{{#include src/doc_examples/untested_06/hooks_counter_two_state.rs:use_signal_calls}}
```
