...
```rust
{{#include src/doc_examples/untested_03/event_nested.rs:rsx}}
```
...
```rust
{{#include src/doc_examples/untested_03/event_prevent_default.rs:prevent_default}}
```
...
```rust
{{#include src/doc_examples/untested_03/event_handler_prop.rs:component_with_handler}}
```

Then, you can use it like any other handler:

```rust
{{#include src/doc_examples/untested_03/event_handler_prop.rs:usage}}
```
