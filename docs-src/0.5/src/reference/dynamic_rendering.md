...
```rust, no_run
{{#include ../docs-examples/src/conditional_rendering.rs:if_else}}
```
```inject-dioxus
DemoFrame {
...
```rust, no_run
{{#include ../docs-examples/src/conditional_rendering.rs:if_else_improved}}
```
```inject-dioxus
DemoFrame {
...
```rust, no_run
{{#include ../docs-examples/src/untested_05/component_children_inspect.rs:Clickable}}
```
...
```rust, no_run
{{#include ../docs-examples/src/conditional_rendering.rs:conditional_none}}
```
...
```rust, no_run
{{#include ../docs-examples/src/rendering_lists.rs:render_list}}
```
```inject-dioxus
DemoFrame {
  rendering_lists::App {}
...
```rust, no_run
{{#include ../docs-examples/src/rendering_lists.rs:render_list_for_loop}}
```
```inject-dioxus
DemoFrame {
