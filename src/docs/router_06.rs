...
impl BookRoute {
    ...
    pub fn page_id(&self) -> use_mdbook::mdbook_shared::PageId {
        match self {
            ...
            BookRoute::GuideMultiplatform {} => use_mdbook::mdbook_shared::PageId(10usize),
            ...
            BookRoute::EssentialsLifecycleIndex {} => use_mdbook::mdbook_shared::PageId(15usize),
            BookRoute::EssentialsStateIndex {} => use_mdbook::mdbook_shared::PageId(16usize),
            BookRoute::EssentialsBreakingIndex {} => use_mdbook::mdbook_shared::PageId(17usize),
            BookRoute::EssentialsStructureIndex {} => use_mdbook::mdbook_shared::PageId(18usize),
            BookRoute::EssentialsRsxIndex {} => use_mdbook::mdbook_shared::PageId(19usize),
            ...
            BookRoute::RouterExampleIndex {} => use_mdbook::mdbook_shared::PageId(22usize),
            BookRoute::RouterExampleFirstRoute {} => use_mdbook::mdbook_shared::PageId(23usize),
            BookRoute::RouterExampleBuildingANest {} => use_mdbook::mdbook_shared::PageId(24usize),
            ...
            BookRoute::RouterExampleFullCode {} => use_mdbook::mdbook_shared::PageId(27usize),
            BookRoute::RouterReferenceIndex {} => use_mdbook::mdbook_shared::PageId(28usize),
            BookRoute::RouterReferenceRoutesIndex {} => use_mdbook::mdbook_shared::PageId(29usize),
            BookRoute::RouterReferenceRoutesNested {} => use_mdbook::mdbook_shared::PageId(30usize),
            BookRoute::RouterReferenceLayouts {} => use_mdbook::mdbook_shared::PageId(31usize),
            ...
            BookRoute::ReferenceAssets {} => use_mdbook::mdbook_shared::PageId(37usize),
            BookRoute::ReferenceWebIndex {} => use_mdbook::mdbook_shared::PageId(38usize),
            BookRoute::ReferenceDesktopIndex {} => use_mdbook::mdbook_shared::PageId(39usize),
            BookRoute::ReferenceMobileIndex {} => use_mdbook::mdbook_shared::PageId(40usize),
            BookRoute::ReferenceMobileApis {} => use_mdbook::mdbook_shared::PageId(41usize),
            BookRoute::ReferenceSsr {} => use_mdbook::mdbook_shared::PageId(42usize),
            BookRoute::ReferenceFullstackIndex {} => use_mdbook::mdbook_shared::PageId(43usize),
            ...
            BookRoute::ReferenceFullstackRouting {} => use_mdbook::mdbook_shared::PageId(48usize),
            BookRoute::CookbookPublishing {} => use_mdbook::mdbook_shared::PageId(49usize),
            BookRoute::CookbookAntipatterns {} => use_mdbook::mdbook_shared::PageId(50usize),
            BookRoute::CookbookErrorHandling {} => use_mdbook::mdbook_shared::PageId(51usize),
            BookRoute::CookbookIntegrationsIndex {} => use_mdbook::mdbook_shared::PageId(52usize),
            BookRoute::CookbookIntegrationsLogging {} => use_mdbook::mdbook_shared::PageId(53usize),
            BookRoute::CookbookIntegrationsInternationalization {} => {
                use_mdbook::mdbook_shared::PageId(54usize)
            }
            BookRoute::CookbookStateIndex {} => use_mdbook::mdbook_shared::PageId(55usize),
            BookRoute::CookbookStateExternalIndex {} => use_mdbook::mdbook_shared::PageId(56usize),
            BookRoute::CookbookStateCustomHooksIndex {} => {
                use_mdbook::mdbook_shared::PageId(57usize)
            }
            BookRoute::CookbookTesting {} => use_mdbook::mdbook_shared::PageId(58usize),
            BookRoute::CookbookExamples {} => use_mdbook::mdbook_shared::PageId(59usize),
            BookRoute::CookbookTailwind {} => use_mdbook::mdbook_shared::PageId(60usize),
            BookRoute::CookbookOptimizing {} => use_mdbook::mdbook_shared::PageId(61usize),
            BookRoute::MigrationIndex {} => use_mdbook::mdbook_shared::PageId(62usize),
            BookRoute::ContributingIndex {} => use_mdbook::mdbook_shared::PageId(63usize),
            ...
            BookRoute::ContributingRoadmap {} => use_mdbook::mdbook_shared::PageId(66usize),
        }
    }
}
...
pub fn MigrationIndex() -> dioxus::prelude::Element {
    ...
    rsx! {
        ...
        p { "Dioxus 0.6:" }
        CodeBlock {
            contents: "<pre style=\"background-color:#0d0d0d;\">\n<span style=\"color:#f92672;\">use </span><span style=\"color:#f8f8f2;\">dioxus::prelude::</span><span style=\"color:#f92672;\">*</span><span style=\"color:#f8f8f2;\">;\n</span><span style=\"color:#f8f8f2;\">\n</span><span style=\"font-style:italic;color:#66d9ef;\">fn </span><span style=\"color:#a6e22e;\">app</span><span style=\"color:#f8f8f2;\">() -&gt; Element {{\n</span><span style=\"color:#f8f8f2;\">    rsx! {{\n</span><span style=\"color:#f8f8f2;\">        img {{\n</span><span style=\"color:#f8f8f2;\">            src: asset!(</span><span style=\"color:#ffee99;\">&quot;/assets/static/bundle.png&quot;</span><span style=\"color:#f8f8f2;\">)\n</span><span style=\"color:#f8f8f2;\">        }}\n</span><span style=\"color:#f8f8f2;\">    }}\n</span><span style=\"color:#f8f8f2;\">}}</span></pre>\n",
            name: "migration.rs".to_string(),
        }
    }
}
