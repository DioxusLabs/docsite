...
```rust, no_run
{{#include ../docs-examples/src/untested_06/event_click.rs:rsx}}
```
```inject-dioxus
DemoFrame {
    event_click::App {}
...
```rust, no_run
{{#include ../docs-examples/src/untested_06/event_nested.rs:rsx}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_06/event_prevent_default.rs:prevent_default}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_06/event_handler_prop.rs:component_with_handler}}
```

Then, you can use it like any other handler:

```rust, no_run
{{#include ../docs-examples/src/untested_06/event_handler_prop.rs:usage}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_06/event_handler_prop.rs:custom_data}}
```
...
```rust, no_run
{{#include ../docs-examples/src/untested_06/event_handler_prop.rs:callback}}
```
