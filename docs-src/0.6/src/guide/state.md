...
```rust
{{#include ../docs-examples/src/untested_06/guide_state.rs:split_app}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/guide_state.rs:event_handler}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/guide_state.rs:use_hook}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/guide_state.rs:context}}
```

You can combine `use_signal` and `Context` to provide reactive state to your app:

```rust
{{#include ../docs-examples/src/untested_06/guide_state.rs:signal_context}}
```

With `use_context` and `consume_context`, you can easily reach up to modify that state:

```rust
{{#include ../docs-examples/src/untested_06/guide_state.rs:signal_context_usage}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/guide_state.rs:initialize_global_signal}}
```

And then read and write to it from anywhere:

```rust
{{#include ../docs-examples/src/untested_06/guide_state.rs:use_global_signal}}
```
