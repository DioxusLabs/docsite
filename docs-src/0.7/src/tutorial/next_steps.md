...
- [Component Lifecycle](../essentials/advanced/lifecycle.md) teaches you about the lifecycle of components along with the hooks you need to run code when the component is first created, mounted, and removed.
...
- [Breaking Out](../essentials/basics/breaking_out.md) will teach you how to break out of Dioxus' rendering model to run JavaScript or interact with the DOM directly with `web-sys`.
