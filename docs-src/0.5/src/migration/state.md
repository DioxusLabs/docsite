...
```rust
{{#include ../docs-examples/src/untested_05/migration_state.rs:use_signal}}
```
...
```rust
{{#include ../docs-examples/src/untested_05/migration_state.rs:context_signals}}
```
...
```rust
{{#include ../docs-examples/src/untested_05/migration_state.rs:peek}}
```
...
```rust
{{#include ../docs-examples/src/untested_05/migration_state.rs:global_signals}}
```
