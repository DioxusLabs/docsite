...
```rust
{{#include src/doc_examples/untested_06/assets.rs:images}}
```
...
```rust
{{#include src/doc_examples/untested_06/assets.rs:optimized_images}}
```
...
```rust
{{#include src/doc_examples/untested_06/assets.rs:arbitrary_files}}
```
...
```rust
{{#include src/doc_examples/untested_06/assets.rs:style_sheets}}
```
