...
Let's continue building on the app we made in the [入门指南](../../getting_started/fullstack.md) guide. We will add a server function to our app that allows us to double the count on the server.
