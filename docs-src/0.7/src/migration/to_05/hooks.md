...
```rust
{{#include ../docs-router/src/doc_examples/untested_05/migration_hooks.rs:use_resource}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_05/migration_hooks.rs:dependencies}}
```
