...
```rust
{{#include ../docs-examples/src/untested_04/hackernews_state.rs:app_v1}}
```
...
```rust
{{#include ../docs-examples/src/untested_04/hackernews_state.rs:story_listing_listener}}
```
...
```rust
{{#include ../docs-examples/src/untested_04/hackernews_state.rs:shared_state_app}}
```

```rust
{{#include ../docs-examples/src/untested_04/hackernews_state.rs:shared_state_stories}}
```

```rust
{{#include ../docs-examples/src/untested_04/hackernews_state.rs:shared_state_preview}}
```
