...
```rust
{{#include src/doc_examples/untested_06/anti_patterns.rs:nested_fragments}}
```
...
```rust
{{#include src/doc_examples/untested_06/anti_patterns.rs:iter_keys}}
```
...
```rust
{{#include src/doc_examples/untested_06/anti_patterns.rs:interior_mutability}}
```
...
```rust
{{#include src/doc_examples/untested_06/anti_patterns.rs:updating_state}}
```
...
```rust
{{#include src/doc_examples/untested_06/anti_patterns.rs:large_state}}
```
...
```rust
{{#include src/doc_examples/untested_06/anti_patterns.rs:non_deterministic}}
```
...
```rust
{{#include src/doc_examples/untested_06/anti_patterns.rs:permissive_partial_eq}}
```