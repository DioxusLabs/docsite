...
```rust
{{#include ../docs-examples/src/untested_06/static_segments.rs:route}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/dynamic_segments.rs:route}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/catch_all_segments.rs:route}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/query_segments.rs:route}}
```
