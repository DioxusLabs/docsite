...
```rust
{{#include ../docs-router/src/doc_examples/untested_04/anti_patterns.rs:nested_fragments}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_04/anti_patterns.rs:iter_keys}}
```
