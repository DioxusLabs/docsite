...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/guide_data_fetching.rs:dog_api}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/guide_data_fetching.rs:dog_view_reqwest}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/guide_data_fetching.rs:spawn}}
```
...
```rust
{{#include ../docs-router/src/doc_examples/untested_06/guide_data_fetching.rs:dog_view_resource}}
```
