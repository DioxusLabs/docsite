...
```rust, no_run
{{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:text}}
```
...
```rust, no_run
{{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:formatted_text}}
```
...
```rust, no_run
{{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:input}}
```
...
>
> ```rust, no_run
> {{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:web_component}}
> ```
...
```rust, no_run
{{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:input_type}}
```
...
```rust, no_run
{{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:input_value}}
```
...
```rust, no_run
{{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:input_disabled}}
```
...
```rust, no_run
{{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:on_input}}
```
...
```rust, no_run
{{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:input_children}}
```
...
```rust, no_run
{{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:for_loop}}
```
...
```rust, no_run
{{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:keyed_for_loop}}
```
...
```rust, no_run
{{#include src/doc_examples/untested_06/building_uis_with_rsx.rs:if_statement}}
```
