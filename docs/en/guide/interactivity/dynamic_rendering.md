...
```rust
{{#include docs/examples/conditional_rendering.rs:if_else}}
```
...
```rust
{{#include docs/examples/conditional_rendering.rs:if_else_improved}}
```
...
```rust
{{#include docs/examples/component_children_inspect.rs:Clickable}}
```
...
```rust
{{#include docs/examples/conditional_rendering.rs:conditional_none}}
```
...
```rust
{{#include docs/examples/rendering_lists.rs:render_list}}
```
...
```rust
{{#include docs/examples/rendering_lists.rs:render_list_for_loop}}
```
