...
```rust
{{#include ../docs-examples/src/untested_06/hooks_composed.rs:wrap_context}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/hooks_composed.rs:use_storage}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/hooks_custom_logic.rs:use_signal}}
```
...
```rust
{{#include ../docs-examples/src/untested_06/hooks_custom_logic.rs:use_context}}
```
