...
> If you are not familiar with Dioxus itself, check out the [Dioxus tutorial](../tutorial/index.md) first.
...
This book is intended to get you up to speed with Dioxus Router.
