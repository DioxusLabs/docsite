...
```rust, ignore
{{#include src/doc_examples/untested_04/custom_renderer.rs:derive_state}}
```

Lets take a look at how to implement the State trait for a simple renderer.

```rust
{{#include src/doc_examples/untested_04/custom_renderer.rs:state_impl}}
```
...
```rust
{{#include src/doc_examples/untested_04/custom_renderer.rs:rendering}}
```
...
```rust
{{#include src/doc_examples/untested_04/custom_renderer.rs:cursor}}
```
