...
> For more detailed docs about the structure of templates see the [Template api docs](https://docs.rs/dioxus-core/0.5.6/dioxus_core/prelude/struct.Template.html)
