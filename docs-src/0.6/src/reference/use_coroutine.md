...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_06/use_coroutine_reference.rs:component}}
```
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_06/use_coroutine_reference.rs:to_owned}}
```
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_06/use_coroutine_reference.rs:to_owned_continued}}
```
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_06/use_coroutine_reference.rs:send}}
```
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_06/use_coroutine_reference.rs:services}}
```
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_06/use_coroutine_reference.rs:global}}
```

Now, in our sync service, we can structure our state however we want. We only need to update the view values when ready.

```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_06/use_coroutine_reference.rs:global_continued}}
```
...
```rust, no_run
{{#include ../docs-router/src/doc_examples/untested_06/use_coroutine_reference.rs:injection}}
```
